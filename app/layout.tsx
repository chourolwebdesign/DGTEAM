...
export default function RootLayout({children}:{children:React.ReactNode}){return <html lang="de" className={manrope.variable}><body><a className="skip-link" href="#main">Zum Inhalt springen</a><ScrollProgress/><JsonLd data={organizationJsonLd}/><Header/><main id="main">{children}</main><Footer/></body></html>}
