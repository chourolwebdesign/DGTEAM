...
export function Footer(){return <>
  <footer className="footer"><div className="container"><div className="footer-grid">
    ...
    <div><h3>Unternehmen</h3><Link href="/#ueber-uns">Über uns</Link><Link href="/#ablauf">Ablauf</Link><Link href="/einsatzgebiete">Einsatzgebiete</Link><Link href="/karriere">Karriere</Link><Link href="/kontakt">Kontakt</Link></div>
